...
public class LastCommand extends Command {
    ...
    public static final String MESSAGE_USAGE = COMMAND_WORD + ": Finds Lowest persons "
            + "has the lowest score in the subject"
            + "Example: " + COMMAND_WORD + " english";

    public static final String MESSAGE_TOP_PERSON = "Lowest %1$s Scorer: %2$s %3$d";
    ...
    public LastCommand(String subject) {
    ...
    public boolean equals(Object other) {
        return other == this // short circuit if same object
                || (other instanceof LastCommand // instanceof handles nulls
                && subject.equals(((LastCommand) other).subject)); // state check
    }
}
