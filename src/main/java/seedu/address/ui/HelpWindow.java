...
public class HelpWindow extends UiPart<Stage> {
    ...
    public static final String USERGUIDE_URL = "https://github.com/AY2122S2-TIC4002-F18-2"
            + "/tp2/blob/master/docs/UserGuide.md";
    public static final String HELP_MESSAGE = "Adding a person: add n/NAME p/PHONE_NUMBER e/CLASS"
