...
This application is for `social media managers` who need to track monthly social media content posting schedule so that
they won't miss out any days without posting content for their client. Meanwhile, they prefer to use the command line to
save the ready-made content link over the GUI and have tons of content to keep track.
